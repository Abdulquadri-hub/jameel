                ...
                <form wire:submit='save'>
                  <div class="row">
                    <div class="form-group col-6">
                      ...
                      <input id="product" wire:model.live.debounce.5ms='product' type="text" class="form-control" name="product" autofocus>
                  ...
                  <div class="row">
                    <div class="form-group col-6">
                      <div class="custom-control custom-checkbox">
                        <input wire:mode='returnable' type="checkbox" value='1' name="returnable" class="custom-control-input" id="agree">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-4">
                      <label>Image 1</label>
                      <input id="image1" wire:model.debounce.1ms='image1'  type="file" class="form-control" name="image1">
                    ...
                    <div class="form-group col-4">
                      <label>Image 2</label>
                      <input id="image2" wire:model.debounce.1ms='image2'  type="file" class="form-control" name="image2">
                    ...
                    <div class="form-group col-4">
                      <label>Image 3</label>
                      <input id="image3" wire:model.debounce.1ms='image3'  type="file" class="form-control" name="image3">
